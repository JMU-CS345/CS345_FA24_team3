...
function GetMap(level) {
  ...
  switch (level) {
    case "map1":
      let platform1 = { x: windowWidth * 0.2, y: (windowHeight * 0.75) + mapScroll, w: asteriodBeltWidth, h: asteriodBeltHeight };
      let platform2 = { x: windowWidth * 0.45, y: windowHeight * 0.6 + mapScroll, w: asteriodBeltWidth, h: asteriodBeltHeight };
      let goal1 = { x: windowWidth * 0.45, y: windowHeight * 0.6 + mapScroll, w: asteriodBeltWidth, h: asteriodBeltHeight };
